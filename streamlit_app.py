...
# Streamlit input widgets for connection details (no username or password)
...
if st.button('Load Data'):
    try:
        # Establish connection using pymssql with Trusted Connection
        conn = pymssql.connect(
            server=server_name,
            database=database_name,
            trusted=True  # Enable Trusted_Connection (Windows Authentication)
        )
